...
void startScreen() {                
  ...
  display.println(F("TEAM 66"));   
  display.setTextSize(1);     
  display.setCursor(10, 25);      
  display.println(F("Measurment Project"));      
  ...
  display.println(F("Ahmed Araby"));   
   
  display.setCursor(10, 10);      
  display.println(F("Hassan Fathy"));      
  display.setCursor(10, 20);   
  display.println(F("Mai Nagah"));
  display.setCursor(10, 30);      
  display.println(F("Muhammed Qasem"));      
  display.setCursor(10, 40);   
  display.println(F("Youssef Ahmed"));
  display.setCursor(10, 50);   
  display.println(F("Ahmed Samy"));
  display.display();                 
  delay(6000);
  display.clearDisplay();
  display.setTextSize(1);            
